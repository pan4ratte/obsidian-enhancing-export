export default {
  ...
  ZOTERO: 'Zotero',
  ZOTERO_DESC: 'Citations straight from your Zotero library. Needs Zotero running, with the Better BibTeX plugin installed.',
  ZOTERO_LINKS: 'Live Zotero fields',
  ZOTERO_LINKS_DESC: 'Turn [@citekey] into live Zotero fields: the document opens in Word or LibreOffice and Refresh goes on working. The sources are read straight from the library, with no .bib to export first.',
  ZOTERO_STYLE: 'Zotero style',
  ZOTERO_STYLE_DESC: 'A style from your Zotero library. The citations are written out at export and the document records that style, so Refresh has nothing to reformat.',
  ...
  WRAP: 'Line wrapping',
  WRAP_DEFAULT: 'Default (wrap at a column)',
  WRAP_MODE_LABELS: {
