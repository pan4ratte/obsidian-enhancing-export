export default {
  ...
  PANDOC_OPEN_MANUAL: 'Open manual',
  ...
  WASM_TITLE: 'Pandoc for mobile',
  WASM_DESC: 'A build of Pandoc that runs inside Obsidian itself, with nothing to install on the system. This is what a phone or tablet uses.',
  WASM_ENGINE: 'What converts',
  WASM_ENGINE_NATIVE: 'The installed Pandoc only',
  WASM_ENGINE_WASM: 'The built-in Pandoc only',
  WASM_ENGINE_AUTO: 'Installed on a computer, built-in on a phone',
  WASM_VERSION: (version: string) => `Built-in Pandoc ${version}`,
  ...
  WASM_UPDATE: 'Update',
  WASM_REMOVE: 'Remove',
  WASM_REMOVE_CONFIRM: 'Remove the built-in Pandoc? That frees about 56 MB.',
  ...
  WASM_UNAVAILABLE: 'This device is too old for the built-in Pandoc: it needs iOS 18.4, an up-to-date Android WebView, or a newer Obsidian.',
