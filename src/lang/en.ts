export default {
  ...
  PANDOC_PATH_PLACEHOLDER: '(Auto detect)',
  ...
  WORD_STYLES: 'Styles',
  WORD_STYLES_DESC: 'What the reference document gets to decide. Each of these is something pandoc otherwise settles for you.',
  FIGURE_STYLE: 'Style images as figures',
  FIGURE_STYLE_DESC: 'Give an image with no caption a paragraph style of its own, instead of leaving it in body text.',
  FIGURE_STYLE_NAME: 'Figure style',
  STYLE_NAME_DESC: 'The paragraph style to set, which the reference document has to hold.',
  TABLE_STYLE: 'Style text in table cells',
  TABLE_STYLE_DESC: 'Stop pandoc stamping its own “Compact” style on every cell, which outranks the table style in Word.',
  TABLE_STYLE_NAME: 'Cell style',
  TABLE_HEAD_STYLE_NAME: 'Header cell style',
